...
/**
 * @minions-sprint-master/cli — CLI for Minions Sprint-master
 *
...
import { customTypes } from '@minions-sprint-master/sdk';
...
program
    ...
    .action(() => {
        ...
        console.log(`  Python: ${chalk.cyan('minions-sprint-master')}`);
