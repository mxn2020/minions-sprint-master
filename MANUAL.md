# Manual Setup Steps for Minions Sprint-master
...
Go to **GitHub → mxn2020/minions-sprint-master → Settings → Secrets and variables → Actions** and add:

| Secret | Description | Where to get it |
|--------|-------------|-----------------|
| `NPM_TOKEN` | npm publish token | [npmjs.com → Access Tokens](https://www.npmjs.com/settings/~/tokens) |
| `PYPI_TOKEN` | PyPI API token for `minions-sprint-master` | [pypi.org → Account Settings → API tokens](https://pypi.org/manage/account/#api-tokens) |
...
### Web App (Playground)
- **Netlify site name**: `minions-sprint-master-web`
- **GitHub repo**: `mxn2020/minions-sprint-master`
- **Base directory**: `apps/web`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/web/dist`
- **Custom domain**: `sprint-master.minions.wtf`

### Documentation
- **Netlify site name**: `minions-sprint-master-docs`
- **GitHub repo**: `mxn2020/minions-sprint-master`
- **Base directory**: `apps/docs`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/docs/dist`
- **Custom domain**: `sprint-master.minions.help`

### Blog
- **Netlify site name**: `minions-sprint-master-blog`
- **GitHub repo**: `mxn2020/minions-sprint-master`
- **Base directory**: `apps/blog`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/blog/dist`
- **Custom domain**: `sprint-master.minions.blog`
...
|--------|------|------|-------|
| Docs | CNAME | `sprint-master.minions.help` | _(Netlify subdomain)_ |
| Blog | CNAME | `sprint-master.minions.blog` | _(Netlify subdomain)_ |
| App  | CNAME | `sprint-master.minions.wtf` | _(Netlify subdomain)_ |
...
Your packages:
- SDK: [`@minions-sprint-master/sdk`](https://www.npmjs.com/package/@minions-sprint-master/sdk)
- CLI: [`@minions-sprint-master/cli`](https://www.npmjs.com/package/@minions-sprint-master/cli)
...
Your package: [`minions-sprint-master`](https://pypi.org/project/minions-sprint-master/)
...
| Item | Value |
|------|-------|
| Project | `minions-sprint-master` |
| SDK (npm) | `@minions-sprint-master/sdk` |
| CLI (npm) | `@minions-sprint-master/cli` |
| Python (PyPI) | `minions-sprint-master` |
| GitHub | `github.com/mxn2020/minions-sprint-master` |
| Docs domain | `sprint-master.minions.help` |
| Blog domain | `sprint-master.minions.blog` |
| App domain | `sprint-master.minions.wtf` |
