# Contributing to Minions Sprint-master

Thank you for your interest in contributing to Minions Sprint-master!

## Getting Started

1. Fork the repository
2. Clone your fork: `git clone https://github.com/YOUR_USERNAME/minions-sprint-master.git`
